                ...
                <div class="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center gap-3">
                            <span class="text-sm text-slate-600 w-12">5 â­</span>
                        ...
                        <div class="flex items-center gap-3">
                            <span class="text-sm text-slate-600 w-12">4 â­</span>
                            <div class="flex-1 bg-slate-200 rounded-full h-2">
                        ...
                        <div class="flex items-center gap-3">
                            <span class="text-sm text-slate-600 w-12">3 â­</span>
                            <div class="flex-1 bg-slate-200 rounded-full h-2">
                        ...
                        <div class="flex items-center gap-3">
                            <span class="text-sm text-slate-600 w-12">2 â­</span>
                            <div class="flex-1 bg-slate-200 rounded-full h-2">
                        ...
                        <div class="flex items-center gap-3">
                            <span class="text-sm text-slate-600 w-12">1 â­</span>
                            <div class="flex-1 bg-slate-200 rounded-full h-2">
                                <div class="bg-yellow-400 h-2 rounded-full" style="width: 1%"></div>
                            </div>
                            <span class="text-sm text-slate-600 w-12 text-right">1%</span>
